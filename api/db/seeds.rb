...
Tour.create(name: "時計台観光", tour_state_code: 1, start_datetime: "2020-06-26T17:00:00",
            end_datetime: "2020-06-26T18:00:00", adult_num: 10, child_num: 1, guide_num: 1, send_remind: true, schedule_input_deadline: "2020-06-20")
Tour.create(name: "大通公園観光", tour_state_code: 2, start_datetime: "2020-07-26T13:00:00",
            end_datetime: "2020-07-26T15:00:00", adult_num: 8, child_num: 4, guide_num: 2, send_remind: true, schedule_input_deadline: "2020-06-20")
Tour.create(name: "藻岩山観光", tour_state_code: 4, start_datetime: "2020-07-28T20:00:00",
            end_datetime: "2020-07-28T22:00:00", adult_num: 7, child_num: 0, guide_num: 1, send_remind: true, schedule_input_deadline: "2020-06-20")
Tour.create(name: "藻岩山観光", tour_state_code: 32, start_datetime: "2020-08-13T20:00:00",
            end_datetime: "2020-07-28T22:00:00", adult_num: 12, child_num: 2, guide_num: 1, send_remind: true, memo: "台風のため中止", schedule_input_deadline: "2020-06-20")
Tour.create(name: "函館山観光", tour_state_code: 256, start_datetime: "2020-08-23T23:00:00",
            end_datetime: "2020-08-24T02:00:00", adult_num: 12, child_num: 0, guide_num: 2, send_remind: true, memo: "日付をまたぎます", schedule_input_deadline: "2020-08-22")
Tour.create(name: "室蘭観光", tour_state_code: 1, start_datetime: "2020-09-23T10:00:00",
            end_datetime: "2020-09-23T18:00:00", adult_num: 20, child_num: 6, guide_num: 8, send_remind: true, memo: "ガイドが多く必要です", schedule_input_deadline: "2020-09-22")
Tour.create(name: "知床観光", tour_state_code: 1, start_datetime: "2020-09-20T19:00:00",
            end_datetime: "2020-09-21T18:00:00", adult_num: 2, child_num: 1, guide_num: 1, send_remind: true, memo: "", schedule_input_deadline: "2020-09-19")
Tour.create(name: "ラーメン巡り", tour_state_code: 1, start_datetime: "2022-09-15T11:00:00",
            end_datetime: "2022-09-16T15:00:00", adult_num: 15, child_num: 2, guide_num: 2, send_remind: true, memo: "1日目昼・夜、2日目朝・昼にラーメンを食べるツアーです。", schedule_input_deadline: "2020-09-08")
...
(1..4).each do |num|
  TourGuide.create(tour_id: num, guide_id: num)
end
