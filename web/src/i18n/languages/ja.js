...
lang.pages.help = {
    ...
    how_creat_accounts: "アカウント作成は管理者のみが行うことができ、ガイド、管理者の両方のを作成することができます。",
    how_creat_guide: "項目は3つあり、名前（必須）、メールアドレス（必須）、メモとなっています。\
    メールアドレスは、`@`や`.`がないもの、末尾が数字で終わるものなどは登録することが出来ません。\
    また、すでに登録済みにメールアドレスは使用することが出来ません。ご注意ください。\
    メモについては必須の項目ではないので、未記入でも登録できます。 \n※どの項目においても作成後に、編集することが可能です。\
    ",
    how_creat_admin: "項目は2つあり、名前、メールアドレスとなっています。\
    メールアドレスは、`@`や`.`がないもの、末尾が数字で終わるものなどは登録することが出来ません。\
    また、すでに登録済みにメールアドレスは使用することが出来ません。ご注意ください。\
    ※どの項目においても作成後に、編集することが可能です。\
    ",
    ...
    リマインドメール：ツアー前日に担当ガイドへメールを送信するかの設定です。\
    メール送信：ガイドへ予定入力依頼のメールを送信するかの設定です（開始日が過去の日時の場合は送信されません）。\
    大人、子供、ガイドの最大人数はそれぞれ9999人となっています。それ以上の人数は登録することが出来ません。\
    ツアー名、開始日時、終了日時に関しては必須の項目であり、後から変更することが出来ません。ご注意ください。\
    その他の項目に関しては、ツアー作成後変更することが可能です。\
    ",
};
