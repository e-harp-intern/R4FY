...
lang.pages.help = {
    ...
    how_create_accounts: "アカウントの作成は管理者のみ行なうことができます。アカウントには管理者とガイドの２種類があります。",
    subtitle2: "ガイド",
    how_create_guide: "\
ツアーの予定を作成した際に、予定入力を依頼するアカウントです。\n\
\n\
設定ができる項目は3つあり、名前（必須）、メールアドレス（必須）、メモとなっています。\n\
すでに登録済みのメールアドレスは使用することが出来ません。\n\
メモは管理者からのみ確認することができます。\n\
※作成後に編集ができます。\n\
    ",
    subtitle3: "管理者",
    how_create_admin: "\
...
・メール送信：ガイドへ予定入力依頼のメールを送信するかの設定です（開始日が過去の日時の場合は送信されません）。\n\
\n\
※最大人数はそれぞれ 9,999人となっています。それ以上の人数は登録することが出来ません。\n\
